...
def print_save_message(args, save_name, thresholds_optimal):
    if args.dataset.startswith('TCGA-lung'):
        print('Best model saved at: ' + save_name + ' Best thresholds: auc_LUAD %.4f, auc_LUSC %.4f' % (thresholds_optimal[0], thresholds_optimal[1]))
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", default="./configs_simea/dsmil_tcga.yaml", type=str)
    parser.add_argument("--split_folder", default="/home/mvu9/processing_datasets/processing_tcga_256/splits_csv", type=str)
    parser.add_argument("--data_dir_map", default={}, type=dict, help="Mapping of labels to data directories")
    parser.add_argument("--save_path", default="/home/mvu9/processing_datasets/processing_tcga_256/results", type=str)
