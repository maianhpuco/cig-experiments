...
rise_clam_ig_camelyon16:
	CUDA_VISIBLE_DEVICES=6 python metric_rise_clam.py --config configs_simea/clam_camelyon16.yaml --ig_name ig

rise_clam_eg_camelyon16:
	CUDA_VISIBLE_DEVICES=6 python metric_rise_clam.py --config configs_simea/clam_camelyon16.yaml --ig_name eg

rise_clam_idg_camelyon16:
	CUDA_VISIBLE_DEVICES=7 python metric_rise_clam.py --config configs_simea/clam_camelyon16.yaml --ig_name idg

rise_clam_cig_camelyon16:
	CUDA_VISIBLE_DEVICES=7 python metric_rise_clam.py --config configs_simea/clam_camelyon16.yaml --ig_name cig

rise_clam_g_camelyon16:
	CUDA_VISIBLE_DEVICES=6 python metric_rise_clam.py --config configs_simea/clam_camelyon16.yaml --ig_name g
