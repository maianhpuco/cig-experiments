...
train_clam_tcga_23fold:
	@echo "Activating conda environment for simea .."
	python train_tcga.py --config configs_simea/clam_tcga_renal.yaml --max_epochs 200 --k_start 2 --k_end 3

train_clam_tcga_56fold:
	@echo "Activating conda environment for simea .."
	python train_tcga.py --config configs_simea/clam_tcga_renal.yaml --max_epochs 200 --k_start 4 --k_end 5
